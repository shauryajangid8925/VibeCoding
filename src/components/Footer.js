    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <h3 className="text-xl font-aeion mb-4">B.M. Institute Of Engineering And Technology</h3>
            <p className="text-gray-400 mb-4">
              Approved by AICTE, Delhi NCR. Providing quality education since 1985.
            </p>
          ...
          >
            <h3 className="text-xl font-aeion mb-4">Quick Links</h3>
            <ul className="space-y-2">
              ...
              <li><a href="#campus3d" className="text-gray-400 hover:text-white transition-colors">Campus Tour</a></li>
          ...
          >
            <h3 className="text-xl font-aeion mb-4">Contact Info</h3>
            <address className="not-italic text-gray-400">
              <p className="mb-2">123 Education Lane</p>
              <p className="mb-2">Knowledge City, DC 10001</p>
              <p className="mb-2">Phone: (555) 123-4567</p>
              <p className="mb-2">Email: info@engineeringtech.edu</p>
            </address>
          </motion.div>
          ...
          >
            <h3 className="text-xl font-aeion mb-4">Newsletter</h3>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} B.M. Institute Of Engineering And Technology. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
